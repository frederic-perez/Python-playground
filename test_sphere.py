...
class Test_Sphere(unittest.TestCase):
    ...
    def test_GIVEN_two_spheres_created_with_the_same_parameters_WHEN_comparing_them_ThenReturnTrue(self):
    ...
    def test_GIVEN_two_spheres_created_with_different_parameters_WHEN_comparing_them_ThenReturnFalse(self):
    ...
    def test_GIVEN_a_sphere_created_with_radius_R_WHEN_calling_get_radius_ThenReturnR(self):
...
class Test_get_sphere(unittest.TestCase):
    ...
    def test_GIVEN_a_point_WHEN_calling_get_sphere_with_that_point_4x__and_get_radius_ThenReturn0(self):
        POINT = np.array([1, 3, 6], np.float_)
        self.assertEqual(get_sphere((POINT, POINT, POINT, POINT)).get_radius(), 0.)

    def test_GIVEN_4_points_from_31_136_12_106_WHEN_calling_get_sphere_using_them_ThenReturnTheSitesResult(self):
    ...
    def test_GIVEN_4_points_from_39_136_10_106_WHEN_calling_get_sphere_using_them_ThenReturnTheSitesResult(self):
    ...
    def test_GIVEN_a_sphere_and_a_point_being_equal_to_center_plus_radius_for_x_WHEN_calling_point_is_on_surface_ThenReturnTrue(self):
    ...
    def test_GIVEN_a_sphere_and_a_point_almost_equal_to_center_plus_radius_for_x_WHEN_calling_point_is_on_surface_ThenReturnTrue(self):
        CENTER = np.array([1, 2, 3], np.float_)
        RADIUS = 7
        SPHERE = Sphere(CENTER, RADIUS)
    ...
    def test_GIVEN_a_sphere_and_a_point_far_enough_to_center_plus_radius_for_x_WHEN_calling_point_is_on_surface_ThenReturnFalse(self):
        CENTER = np.array([1, 2, 3], np.float_)
        RADIUS = 7
        SPHERE = Sphere(CENTER, RADIUS)
